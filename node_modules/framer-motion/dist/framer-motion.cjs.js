...
function setTarget(visualElement, definition) {
    ...
    var _a = resolved
        ...
        : {}, _b = _a.transitionEnd, transitionEnd = _b === void 0 ? {} : _b, _c = _a.transition, target = tslib.__rest(_a, ["transitionEnd", "transition"]);
...
var SVGVisualElement = /** @class */ (function (_super) {
    ...
    SVGVisualElement.prototype.measure = function () {
         ...
         */
        sync__default['default'].render(function () { return _this.render(); });
    };
...
function animateChildren(visualElement, variant, delayChildren, staggerChildren, staggerDirection, options) {
    ...
    Array.from(visualElement.variantChildrenOrder).forEach(function (child, i) {
        var animation = animateVariant(child, variant, tslib.__assign(tslib.__assign({}, options), { delay: delayChildren + generateStaggerDuration(i) }));
        animations.push(animation);
    });
...
function createAnimationState(visualElement) {
    ...
    var buildResolvedTypeValues = function (acc, definition) {
        var resolved = resolveVariant(visualElement, definition);
        if (resolved) {
            var transition = resolved.transition, transitionEnd = resolved.transitionEnd, target = tslib.__rest(resolved, ["transition", "transitionEnd"]);
    ...
    function setProps(props, context, options, changedActiveType) {
        ...
        if (props.variants) {
            visualElement.updateConfig(tslib.__assign(tslib.__assign({}, visualElement.config), { variants: props.variants }));
        }
        /**
        ...
        var _loop_1 = function (i) {
            ...
            if (shouldAnimateType && !isInherited) {
                animations.push.apply(animations, tslib.__spread(definitionList.map(function (animation) { return ({
                    animation: animation,
 ...
 */
var validMotionProps = new Set(tslib.__spread([
    "initial",
    "animate",
    "exit",
    "style",
...
function buildHTMLProps(visualElement, _a) {
    ...
    var htmlProps = {};
    var style = tslib.__assign(tslib.__assign(tslib.__assign({}, visualElement.reactStyle), visualElement.style), visualElement.vars);
    if (!!drag) {
...
function useFeatures(defaultFeatures, isStatic, visualElement, props) {
    ...
    for (var i = 0; i < numFeatures; i++) {
        ...
        if (shouldRender(props)) {
            ...
            Component &&
                features.push(React.createElement(Component, tslib.__assign({ key: key }, props, { visualElement: visualElement })));
        }
    }
    return features;
}
...
exports.useVariantContext = useVariantContext;
